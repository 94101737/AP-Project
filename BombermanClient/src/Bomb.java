...
public class Bomb {
    ...
    public Bomb(int x, int y, boolean c, int er){
    ...
    public void Trigger( Panel Parent){
        ...
        if(!this.CONTROLABLE){
            ...
            Parent.MyBlock[BOMB_COORDINATES.y/Parent.unit][BOMB_COORDINATES.x/Parent.unit].fire(Parent , Parent.MyVariables.shadowTable[BOMB_COORDINATES.y/Parent.unit][BOMB_COORDINATES.x/Parent.unit]);
            ...
            for(int i=1;i<=this.EXPLOSION_RADIUS;i++){
                ...
                Parent.MyBlock[(BOMB_COORDINATES.y/Parent.unit)+i][BOMB_COORDINATES.x/Parent.unit].fire(Parent , Parent.MyVariables.shadowTable[(BOMB_COORDINATES.y/Parent.unit)+i][BOMB_COORDINATES.x/Parent.unit]);
            ...
            for(int i= 1;i<=this.EXPLOSION_RADIUS;i++){
                ...
                Parent.MyBlock[BOMB_COORDINATES.y/Parent.unit][(BOMB_COORDINATES.x/Parent.unit)+i].fire(Parent , Parent.MyVariables.shadowTable[BOMB_COORDINATES.y/Parent.unit][(BOMB_COORDINATES.x/Parent.unit)+i]);
