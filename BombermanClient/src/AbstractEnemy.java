...
public abstract class AbstractEnemy extends Moveable implements Runnable{
    ...
    public boolean Collision (){
        if(twoRectanglesCoincidence(this.Coordiantes.x,this.Coordiantes.y,2*(Parent.unit/3),2*(Parent.unit/3),(Parent.MyVariables.player.Coordiantes.x),(Parent.MyVariables.player.Coordiantes.y),Parent.player_width,Parent.player_height)){
            return true;
        }
        return false;
    }
